...
public class AuthService {
    ...
    public AuthenticationResponse registerStudent(RegisterClientRequest request) {
        ...
        // zedna hedhi bech najmou baed ma sajalna l user nabaathou une reponse feha les infos hedhom
        AuthenticationResponse.UserDetailsDTO userDTO = AuthenticationResponse.UserDetailsDTO.builder()
                .id(savedUser.getId())
                ...
                .prefix(savedUser.getPrefix())
                .build();

        // Construction de la réponse
        return AuthenticationResponse.builder()
                .token(jwtService.generateAccessToken(savedUser))
                .user(userDTO)
                .build();
