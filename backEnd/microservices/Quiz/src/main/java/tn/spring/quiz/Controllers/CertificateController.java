...
public class CertificateController {
    ...
    public ResponseEntity<byte[]> generateAndSend(@RequestBody CertificateRequest request) throws Exception {
        ...
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=membership.pdf")
    ...
    public String verifyCertificate(@PathVariable Long id) {
        ...
        if (exists) {
            return "✅ Membership document is VALID";
        } else {
            return "❌ Membership document NOT FOUND";
        }
    }
    ...
    public Certificate getCertificateByCourseAndStudent(
        ...
        return certificateRepository
                ...
                .orElseThrow(() -> new RuntimeException("Membership document not found"));
    }
}
