...
public class CertificatePdfService {
    ...
    public byte[] generateCertificatePdf(Certificate cert, String userName) {
        ...
        try {
            ...
            // ================= TITLE =================
            Paragraph title = new Paragraph("CERTIFICATE OF MEMBERSHIP")
                    .setBold()
                    .setFontSize(36)
            ...
            Paragraph body = new Paragraph(
                    "has successfully completed the requirements for membership in"
            ).setTextAlignment(TextAlignment.CENTER)
                    .setFontSize(18);
            ...
            // ================= SIGNATURE =================
            Paragraph signature = new Paragraph("Delivered by All About Spelling ")
            ...
            throw new RuntimeException("Error generating membership PDF", e);
        }
    }
